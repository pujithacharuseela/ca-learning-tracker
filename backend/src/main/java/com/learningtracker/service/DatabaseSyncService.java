...
public class DatabaseSyncService {
    ...
    private void initializeH2Schema() {
        ...
        try {
            ...
            backupJdbcTemplate.execute("CREATE TABLE IF NOT EXISTS learning_classes (id UUID PRIMARY KEY, user_id UUID, uploaded_file_id UUID, subject_id UUID, class_no INTEGER, topic VARCHAR, duration_minutes INTEGER, duration_display VARCHAR, is_active BOOLEAN DEFAULT TRUE, created_at TIMESTAMP, updated_at TIMESTAMP)");
